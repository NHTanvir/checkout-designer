...
$config = [
	'per_page'		=> 5,
	'columns'		=> [
		'id'				=> __( 'Order #', 'checkout-designer' ),
		'products'			=> __( 'Products', 'checkout-designer' ),
		'order_total'		=> __( 'Order Total', 'checkout-designer' ),
		'commission'		=> __( 'Commission', 'checkout-designer' ),
		'payment_status'	=> __( 'Payment Status', 'checkout-designer' ),
		'time'				=> __( 'Time', 'checkout-designer' ),
	],
	...
	'bulk_actions'	=> [
		'delete'	=> __( 'Delete', 'checkout-designer' ),
		'draft'		=> __( 'Draft', 'checkout-designer' ),
	],
];
